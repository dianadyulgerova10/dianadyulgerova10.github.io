...
// var first=parseInt(numberStr.charAt(0)); 
// var second=parseInt(numberStr.charAt(numberStr.length-2)); 
// var third=parseInt(numberStr.charAt(numberStr.length-1)); console.log(numberStr.length);

// console.log(unit);
// console.log(ones[unit]);
...
if(number==0){
	...
	var a=tens[tenth];
	var b=ones[unit];
	console.log(tens[tenth]+ones[unit]);
	console.log(a+" "+b) 
}
 ...
 // console.log(ones[hundred]+ " hundreds "+ ones[unit]) ;
  console.log(result);
}
